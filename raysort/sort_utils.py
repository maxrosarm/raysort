...
# This generates a partition's related metadata 
# and gets stored at /tmp/... (generated by python) 
def part_info(
    cfg: AppConfig,
    part_id: PartId,
    *,
    ...
    prefix = cfg.data_dirs[data_dir_idx] # generation of a prefix corresponding to /tmp/...
...
def generate_part(
    ...
    with tracing_utils.timeit("generate_part"):
        ...
        if cfg.cloud_storage:
            ...
            # get partition metadata for a particular partition (path, data)
...
def generate_input(cfg: AppConfig):
    ...
    # commented out drop cache stuff
